...
- **进度**：Step 3 进行中（Set 1 layout + pool 已完成，checkbox 1-3 done）

### 下一个任务

阶段三 Step 3：Descriptor Layout + Compute Infra — 在 `bindings.glsl` 中声明 `samplerCube cubemaps[]`（Set 1 binding 1）。
