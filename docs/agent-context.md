...
- **Phase**：阶段七 — PT 烘焙器
- **进度**：Step 12.5 第 2 小项完成（lightmap_uv.cpp quality 分支 + 缓存隔离）

### 下一个任务

Step 12.5 第 3 小项：`lightmap_uv_generator.h` 新建 LightmapUVGenerator 类声明，详见 `docs/current-phase.md` Step 12.5 章节。
