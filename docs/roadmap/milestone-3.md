# Milestone 3：动态物体 + 画面补全 + 性能优化 + 间接光升级

> **目标**：支持动态物体（非角色），补全画面明显短板，具备应对更大场景规模的性能手段；PT 模式间接光质量跳跃。
...
| 项目 | 说明 |
|------|------|
| ReSTIR GI 替换 SHaRC | 间接光从哈希网格低频近似提升到像素级路径重采样，高频 color bleeding 和小缝隙间接光变化精确可见。接近 Cyberpunk 2077 RT Overdrive 水平。与 M2 ReSTIR DI 同属 ReSTIR 家族，共享概念和基础设施 |
