...
- Bitonic sort correctness baseline；Phase 3.0 末期接 deterministic compact + visible-count-driven 4-bit radix，并保留 Bitonic 作为 Debug UI 对比路径。
