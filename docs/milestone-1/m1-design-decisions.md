...
<!-- MSAA 配置策略、Tonemapping、HDR Color Buffer 格式、Normal Buffer 格式与编码、Depth + Normal PrePass、Forward Pass 升级（阶段三）已迁移至 archive/m1-phase3-decisions.md -->
...
<!-- IBL 管线（阶段三）已迁移至 archive/m1-phase3-decisions.md -->
...
<!-- 阶段三条目（Pass 抽象、Skybox、Descriptor Set 绑定、Exposure、App 层、MSAA、Tonemapping、HDR Color Buffer、Normal Buffer、IBL 管线/验证/旋转、Default light 退役）已迁移至 archive/m1-phase3-decisions.md -->
