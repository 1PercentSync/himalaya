...
namespace himalaya::app {
    ...
    void Application::init(const AppConfig &config) {
        ...
        // --- Renderer (owns pipelines, buffers, default textures, sampler, IBL) ---
        renderer_.init(context_, swapchain_, resource_manager_, descriptor_manager_,
                       imgui_backend_, config.env_path);
